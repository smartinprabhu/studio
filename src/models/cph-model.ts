import { TeamPeriodicMetrics, AggregatedPeriodicMetrics, TeamMetricDefinitions, AggregatedMetricDefinitions } from '@/components/capacity-insights/types';
...
export const CPH_TEAM_METRIC_ROW_DEFINITIONS: TeamMetricDefinitions = [
  ...
  { key: "cph", label: "CPH", isTime: false, isEditableForTeam: true, step: 0.1, category: 'Assumption', description: "Contacts Per Hour: The number of contacts an agent can handle in an hour." },
...
export const CPH_AGGREGATED_METRIC_ROW_DEFINITIONS: AggregatedMetricDefinitions = [
    ...
    { key: "averageCPH", label: "Average CPH", isEditableForLob: true, step: 0.1, isTime: false, description: "Average Contacts Per Hour for the LOB." },
    { key: "lobTotalBaseRequiredMinutes", label: "Total Base Req Mins", isEditableForLob: true, isTime: true, step: 1, description: "Total agent minutes required for LOB volume, calculated as Volume / CPH or input directly." },
