...
export const TEAM_METRIC_ROW_DEFINITIONS_MODEL1: TeamMetricDefinitions = [
...
export const AGGREGATED_METRIC_ROW_DEFINITIONS_MODEL1: AggregatedMetricDefinitions = [
